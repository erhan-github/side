...
from side.intel.sources.base import IntelligenceItem
...
class MarketAnalyzer:
    ...
    async def fetch_all_sources(
        ...
        """
        import asyncio
        from side.sources import HackerNewsSource, LobstersSource, GitHubSource
        from side.intel.sources.legal import LegalHubPlugin
        from side.intel.sources.investment import InvestmentHubPlugin
        from side.intel.sources.base import IntelligenceItem
    ...
    def _apply_diversity_mix(self, items: list[IntelligenceItem]) -> list[IntelligenceItem]:
        ...
        def get_sort_date(item: IntelligenceItem) -> datetime:
