"""
Side Signal Aggregator - The "Deep Market" Fetcher.
...
logger = logging.getLogger("side.intel.signals")

class DomainSources:
    """Registry of high-quality sources."""
    
    # Curated sources (Forensic-level quality)
    SOURCES = {
        "EdTech": [
        ...
        # AI/ML Research Papers (ArXiv)
        "Research": [
            {"url": "https://rss.arxiv.org/rss/cs.AI", "name": "ArXiv AI"},
            {"url": "https://rss.arxiv.org/rss/cs.LG", "name": "ArXiv Machine Learning"},
            {"url": "https://rss.arxiv.org/rss/cs.CL", "name": "ArXiv NLP/LLM"},
        ],
        # Combined AI Feed (for Side's own domain)
        "AI": [
            {"url": "https://rss.arxiv.org/rss/cs.AI+cs.LG+cs.CL", "name": "ArXiv AI+ML+NLP"},
            {"url": "https://news.ycombinator.com/rss", "name": "Hacker News"},
