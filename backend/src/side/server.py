"""
Side Server - Your Strategic Partner.
...
async def get_prompt(name: str, arguments: dict[str, str] | None) -> GetPromptResult:
        ...
        "strategy": lambda: GetPromptResult(
            ...
            messages=[
                PromptMessage(
                    ...
                    content=TextContent(
                        type="text",
                        text=f"Side, what should I focus on?{' Context: ' + args.get('context') if args.get('context') else ''}",
                    ),
                ),
            ],
        ),
    ...
    return GetPromptResult(
        description="Side - Instant Strategic Intelligence",
        messages=[
            PromptMessage(
                role="user",
                content=TextContent(type="text", text="Side, what should I read?"),
            ),
        ],
    )
