...
class ForensicLabel:
    ...
    REGISTRY = {
        "security":          {"tag": "SECURITY",      "icon": "🛡️", "desc": "Sovereignty & Protection"},
        ...
        "marketfit":         {"tag": "STRATEGY",      "icon": "🎯", "desc": "Strategic Alignment"},
        "strategy":          {"tag": "STRATEGY",      "icon": "🎯", "desc": "Strategic Execution"},
        ...
        "law":               {"tag": "LEGAL",         "icon": "📜", "desc": "Legal Sovereignty"},
