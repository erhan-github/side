    ...
    return (
        <main className="min-h-screen flex flex-col items-center overflow-hidden bg-void text-foreground selection:bg-neon/20">
            ...
            <section className="w-full max-w-6xl px-6 pt-32 pb-20 flex flex-col items-center text-center z-10">
                ...
                <p className="text-xl text-white/60 max-w-2xl mb-12 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200 fill-mode-both">
                    The <span className="text-white">Deterministic Control Plane</span> for your LLMs. <br />
                    Stop guessing. Start enforcing.
                </p>

                {/* Platform Switcher (The Infection Vector) */}
                <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-xl p-1 backdrop-blur-md animate-in fade-in zoom-in-95 duration-1000 delay-300">
                    <div className="flex gap-1 mb-4 border-b border-white/5 p-1">
                        <button className="flex-1 py-1.5 text-xs font-medium text-white bg-white/10 rounded shadow-sm">Auto-Install</button>
                        <button className="flex-1 py-1.5 text-xs font-medium text-white/40 hover:text-white transition-colors">Manual</button>
                        <button className="flex-1 py-1.5 text-xs font-medium text-white/40 hover:text-white transition-colors">Source</button>
                    </div>

                    <div className="px-4 pb-4 pt-2">
                        <div className="flex items-center justify-between text-xs text-stockholm-blue mb-2 font-mono">
                            <span>// Detects Cursor, VS Code, Zed, & Terminal</span>
                        </div>
                        <div className="group relative flex items-center bg-black/50 border border-white/10 rounded-lg p-3 font-mono text-sm text-emerald-400">
                            <span className="mr-2 text-white/30">$</span>
                            <span className="flex-1">curl -fsSL sidelith.com/install | sh</span>
                            <button className="absolute right-2 p-1.5 rounded-md hover:bg-white/10 text-white/40 hover:text-white transition-colors">
                                <Command size={14} />
                            </button>
                        </div>
                        <p className="text-[10px] text-white/30 mt-3 text-center">
                            Installs CLI + MCP Server + Extensions
                        </p>
                    </div>
                </div>

                {/* Social Proof (Stack Compatibility) */}
                <div className="mt-16 flex flex-col items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
                    <p className="text-xs text-subtle uppercase tracking-widest font-mono">Deep integration with the modern stack</p>
                    <div className="flex items-center gap-8 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Text-based logos for now, reflecting 'Tech Stack' strategy */}
                        <span className="text-sm font-bold text-white flex items-center gap-2"><div className="w-2 h-2 bg-blue-500 rounded-full" /> Python</span>
                        <span className="text-sm font-bold text-white flex items-center gap-2"><div className="w-2 h-2 bg-yellow-400 rounded-full" /> JavaScript</span>
                        <span className="text-sm font-bold text-white flex items-center gap-2"><div className="w-2 h-2 bg-orange-500 rounded-full" /> Rust</span>
                        <span className="text-sm font-bold text-white flex items-center gap-2"><div className="w-2 h-2 bg-cyan-400 rounded-full" /> Go</span>
                        <span className="text-sm font-bold text-white flex items-center gap-2"><div className="w-2 h-2 bg-blue-300 rounded-full" /> Docker</span>
                    </div>
                </div>
            </section>

            {/* 2. THE PROBLEM (Where AI Fails) */}
            <section className="w-full max-w-4xl px-6 mb-32 text-center animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300">
                <div className="mb-12">
                ...
                <div className="flex flex-col gap-8 text-left max-w-3xl mx-auto">
                    {/* Card 1: Drift */}
                    <div className="p-10 rounded-3xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-colors group">
                        <div className="flex flex-col md:flex-row items-start gap-6">
                            <div className="w-14 h-14 shrink-0 rounded-full bg-red-500/20 flex items-center justify-center text-red-400 group-hover:bg-red-500/30 transition-colors shadow-[0_0_20px_rgba(239,68,68,0.2)]">
                                <Activity size={28} />
                            </div>
                            <div>
                                <span className="block text-sm md:text-base font-bold font-mono text-red-400 uppercase tracking-widest mb-2 shadow-red-500/10 drop-shadow-sm">Stochastic Decay</span>
                                <h3 className="text-2xl md:text-3xl font-heading font-bold text-white mb-4">Mathematical Drift</h3>
                                <p className="text-white/80 text-lg md:text-xl leading-relaxed">
                                    Generated code drift increases non-linearly with codebase size. Without a reference anchor, likelihood of regression approaches 100%.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-10 rounded-3xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-colors group">
                        <div className="flex flex-col md:flex-row items-start gap-6">
                            <div className="w-14 h-14 shrink-0 rounded-full bg-orange-500/20 flex items-center justify-center text-orange-400 group-hover:bg-orange-500/30 transition-colors shadow-[0_0_20px_rgba(249,115,22,0.2)]">
                                <Zap size={28} />
                            </div>
                            <div>
                                <span className="block text-sm md:text-base font-bold font-mono text-orange-400 uppercase tracking-widest mb-2 shadow-orange-500/10 drop-shadow-sm">Context Saturation</span>
                                <h3 className="text-2xl md:text-3xl font-heading font-bold text-white mb-4">Lossy Memory</h3>
                                <p className="text-white/80 text-lg md:text-xl leading-relaxed">
                                    LLMs are stateless. RAG is lossy. You need an active state machine that tracks <b>Semantic Dependency</b> across 10,000+ files.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-10 rounded-3xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-colors group">
                        <div className="flex flex-col md:flex-row items-start gap-6">
                            <div className="w-14 h-14 shrink-0 rounded-full bg-yellow-500/20 flex items-center justify-center text-yellow-400 group-hover:bg-yellow-500/30 transition-colors shadow-[0_0_20px_rgba(234,179,8,0.2)]">
                                <Database size={28} />
                            </div>
                            <div>
                                <span className="block text-sm md:text-base font-bold font-mono text-yellow-400 uppercase tracking-widest mb-2 shadow-yellow-500/10 drop-shadow-sm">Unbounded Risk</span>
                                <h3 className="text-2xl md:text-3xl font-heading font-bold text-white mb-4">Inevitable Chaos</h3>
                                <p className="text-white/80 text-lg md:text-xl leading-relaxed">
                                    Agents without governance are an exfiltration vector. Your codebase requires a <b>Constitutional File System</b>, not just a chat window.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {/* ... (Solution Section is kept intact as it was already optimized) ... */}
            {/* RE-INSERTING THE SOLUTION SECTION CONTENT HERE IF NEEDED, BUT THE REPLACEMENT CHUNK SHOULD END BEFORE IT OR BE SKIPPED VIA RANGE. */}
            {/* The previous REPLACE used precise ranges. This one is targeting the TOP of the file down to the START of the Solution section. */}
            {/* WAIT. The user said 'replace_file_content' is for SINGLE CONTIGUOUS BLOCK. I should be careful not to overwrite the Solution section I just did. */}
            {/* The Solution section starts around line 124. I will end my replacement at line 123. */}
            {/* Actually, I need to do the Pricing section too. I can use 'multi_replace_file_content' to do both ranges (Hero/Problem AND Pricing) or just do two calls. */}
            {/* The tool 'replace_file_content' only supports one block. `multi_replace_file_content` supports multiple. I'll use `multi_replace_file_content`. */}

            {/* Wait, the prompt instruction said 'I will use replace_file_content'. I should stick to that if possible, but if the edits are non-contiguous (Hero is at top, Pricing is at bottom), I must use multi_replace. */}
            {/* The previous edits were in the Solution section (middle). */}
            {/* I will use `multi_replace_file_content` to hit Hero/Problem (Top) and Pricing (Bottom). */}



            {/* 3. THE SOLUTION (The Sovereign Control Loop) */}
            <section className="w-full max-w-6xl px-4 mb-32 z-10 relative">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-heading mb-6 text-white animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                        The Antidote to <span className="text-neon">Entropy</span>.
                    </h2>
                ...
                <div className="w-full max-w-6xl mx-auto mb-40 relative animate-in fade-in zoom-in-95 duration-1000 delay-500 min-h-[900px] hidden md:block">
                    ...
                    <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 1000 800" fill="none">
                        ...
                        <path id="diode-line" d="M 450 450 L 150 400" stroke="white" strokeOpacity="0.2" strokeWidth="1" strokeDasharray="2 4" markerEnd="url(#arrow-head)" />

                        {/* Invisible Path for Text Correction (Left-to-Right) */}
                        <path id="diode-text-path" d="M 150 400 L 450 450" fill="none" stroke="none" />

                        <text dy="-5">
                            <textPath href="#diode-text-path" startOffset="50%" textAnchor="middle" className="fill-white/40 text-[10px] uppercase font-mono tracking-widest">
                                &lt; Anon Patterns Only &gt;
                            </textPath>
                        </text>

                        {/* 3. LEARNING LOOP (Editor -> Memory) */}
                        <path id="learning-line" d="M 300 200 Q 400 300 500 420" stroke="#f59e0b" strokeWidth="3" className="animate-pulse opacity-80" strokeLinecap="round" markerEnd="url(#arrow-head-gold)" />
                        <text dy="-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24 relative">
                    <div className="md:text-right flex flex-col items-start md:items-end justify-center order-2 md:order-1 px-6">
                        <div className="inline-flex items-center gap-2 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24 relative">
                    <div className="order-2 md:order-2 flex flex-col justify-center px-6">
                        ...
                        <p className="text-white/60 text-lg leading-relaxed max-w-sm">
                            ...
                            Before the AI speaks, we perform a <b>Strategic Injection</b>. We force-feed the model the exact dependencies and constraints it needs, reducing the probability of hallucination to near zero. <br /><br />
                            <i>"Deterministic Context."</i>
                        </p>
                    </div>
                    <div className="order-1 md:order-1">
  ...
  "constraints": {
    ...
    "forbidden_patterns": ["GodClass"]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24 relative">
                    <div className="order-2 md:order-2 flex flex-col justify-center px-6">
                        <div className="inline-flex items-center gap-2 mb-4">
                            <span className="text-purple-500 font-mono text-xs font-bold tracking-widest">PHASE_04: INTELLIGENCE</span>
                        ...
                        <div className="h-full min-h-[220px] border border-white/10 rounded-2xl bg-[#0a0a0a] p-6 relative overflow-hidden group font-mono text-xs md:text-sm shadow-2xl hover:border-purple-500/30 transition-colors">
                            ...
                            <div className="space-y-4 pt-2">
                                ...
                                <div className="mt-4 p-3 bg-purple-500/10 border border-purple-500/20 rounded text-purple-300">
                                    {`> Source: "Anonymous Strategy #441"`} <br />
                                    {`> Relevance: 99.9%`}
                                </div>
                            </div>
                        </div>
                ...
                <div className="text-center py-20 relative z-10">
                    <div className="inline-flex flex-col items-center">
                        <div className="w-16 h-16 rounded-full bg-amber-500/10 flex items-center justify-center mb-6 border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.2)]">
                            <Database className="w-8 h-8 text-amber-500" />
                        </div>
                        <h3 className="text-3xl font-heading mb-4 text-white">Long-Term Memory.</h3>
                        <p className="text-white/60 max-w-lg mx-auto leading-relaxed text-lg">
                            Your verification becomes a <b>Strategic Schema</b>. <br />
                            Stored in your Sovereign Ledger. Forever. <br />
                            <span className="text-amber-500 font-bold mt-2 block">"The Operator never forgets."</span>
                        </p>
                    </div>
                </div>
            ...
            <section className="w-full max-w-6xl px-6 py-10 pb-32">
                <div className="text-center mb-16">
                    <h2 className="text-h2 font-heading mb-4">Pay for Intelligence.</h2>
                    <p className="text-white/60">Scalable Side Units (SUs) for your semantic operations.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {/* Free */}
                    <div className="p-6 rounded-xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.02] transition-colors">
                        <div className="text-sm text-subtle mb-4">Free Access</div>
                        <div className="text-3xl font-heading mb-1 text-white">0 <span className="text-sm font-sans text-white/40">SUs</span></div>
                        <div className="text-[10px] text-emerald-400 mb-6 font-mono tracking-wider">LIFETIME GRANT</div>
                        <ul className="space-y-3 text-sm text-white/60 mb-8">
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> 500 Side Units</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> Fractal Indexing</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> Amnesia Recovery</li>
                        </ul>
                    </div>

                    {/* Pro - Featured */}
                    <div className="p-6 rounded-xl border border-blue-500/30 bg-blue-500/[0.03] relative overflow-hidden group">
                        <div className="absolute top-0 right-0 px-3 py-1 bg-blue-500 text-[10px] font-bold text-white">POPULAR</div>
                        <div className="text-sm text-blue-400 mb-4">Pro</div>
                        <div className="text-3xl font-heading mb-1 text-white">$15 <span className="text-sm font-sans text-white/40">/ mo</span></div>
                        <div className="text-[10px] text-white/40 mb-6 font-mono tracking-wider">5,000 SUs / MO</div>
                        <ul className="space-y-3 text-sm text-white/80 mb-8">
                            <li className="flex gap-2 items-center"><Check size={14} className="text-blue-500" /> <b>The Pulse HUD</b></li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-blue-500" /> Deep Forensics</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-blue-500" /> 24h Audit Retention</li>
                        </ul>
                        <button className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-medium text-sm transition-colors shadow-lg shadow-blue-500/20">Start Pro</button>
                    </div>

                    {/* Elite */}
                    <div className="p-6 rounded-xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.02] transition-colors">
                        <div className="text-sm text-subtle mb-4">Elite</div>
                        <div className="text-3xl font-heading mb-1 text-white">$60 <span className="text-sm font-sans text-white/40">/ mo</span></div>
                        <div className="text-[10px] text-white/40 mb-6 font-mono tracking-wider">25,000 SUs / MO</div>
                        <ul className="space-y-3 text-sm text-white/60 mb-8">
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> 10x Throughput</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> Cloud Distillation</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> 30-Day Audit Logs</li>
                        </ul>
                    </div>

                    {/* Enterprise */}
                    <div className="p-6 rounded-xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.02] transition-colors">
                        <div className="text-sm text-subtle mb-4">Enterprise</div>
                        <div className="text-3xl font-heading mb-1 text-white">$50 <span className="text-sm font-sans text-white/40">/ seat</span></div>
                        <div className="text-[10px] text-white/40 mb-6 font-mono tracking-wider">CUSTOM VOLUME</div>
                        <ul className="space-y-3 text-sm text-white/60 mb-8">
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> SSO & Compliance</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> Airgap Mode</li>
                            <li className="flex gap-2 items-center"><Check size={14} className="text-white/20" /> Legal Indemnity</li>
                        </ul>
                    </div>
                </div>
            </section>
