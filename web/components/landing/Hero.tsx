...
export function Hero() {
    return (
        <section className="w-full max-w-5xl px-6 flex flex-col items-center text-center z-10 pt-40 pb-20">
            ...
            <p className="text-lg md:text-2xl text-white/60 max-w-2xl mb-8 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200 fill-mode-both leading-relaxed font-light text-balance">
